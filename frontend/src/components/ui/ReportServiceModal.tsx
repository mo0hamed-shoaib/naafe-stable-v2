...
const ReportServiceModal: React.FC<ReportServiceModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  serviceTitle,
  ...
  const problemTypes = [
    ...
    { value: 'fake_service', label: 'خدمة مزيفة أو احتيالية' },
    { value: 'incomplete_info', label: 'معلومات ناقصة أو غير واضحة' },
    { value: 'wrong_category', label: 'تصنيف خاطئ للخدمة' },
    { value: 'duplicate', label: 'خدمة مكررة' },
    { value: 'inappropriate_budget', label: 'ميزانية غير مناسبة' },
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="الإبلاغ عن مشكلة في الخدمة">
